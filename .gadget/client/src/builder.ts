...
export const buildGlobalAction = (client: { connection: GadgetConnection }, globalAction: GlobalActionOperation) => {
  return Object.assign(async (variables: Record<string, any> = {}) => {
    const resultVariables: VariablesOptions = {};
    for (const [name, variable] of Object.entries(globalAction.variables)) {
    ...
    return await globalActionRunner(client.connection, globalAction.operationName, resultVariables, globalAction.namespace);
  }, globalAction);
};
