...
const buildGlobalAction = (client, globalAction) => {
  return Object.assign(async (variables = {}) => {
    ...
    return await (0, import_api_client_core.globalActionRunner)(client.connection, globalAction.operationName, resultVariables, globalAction.namespace);
  }, globalAction);
};
