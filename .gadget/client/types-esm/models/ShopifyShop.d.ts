...
import { Query, Select, DeepFilterNever, ShopifyShop, ShopifyShopSort, ShopifyShopFilter, AvailableShopifyShopSelection, Scalars } from "../types.js";
 ...
 * "Is a GadgetRecord of the model's type."
 **/
export type SavePrePurchaseProductShopifyShopResult<Options extends SavePrePurchaseProductShopifyShopOptions> = SelectedShopifyShopOrDefault<Options> extends void ? void : GadgetRecord<SelectedShopifyShopOrDefault<Options>>;
/**
  ...
  */
declare function savePrePurchaseProductShopifyShop<Options extends SavePrePurchaseProductShopifyShopOptions>(id: string, variables: SavePrePurchaseProductShopifyShopVariables, options?: LimitToKnownKeys<Options, SavePrePurchaseProductShopifyShopOptions>): Promise<SavePrePurchaseProductShopifyShopResult<Options>>;
declare function savePrePurchaseProductShopifyShop<Options extends SavePrePurchaseProductShopifyShopOptions>(id: string, variables: FullyQualifiedSavePrePurchaseProductShopifyShopVariables, options?: LimitToKnownKeys<Options, SavePrePurchaseProductShopifyShopOptions>): Promise<SavePrePurchaseProductShopifyShopResult<Options>>;
...
*/
    bulkSavePrePurchaseProduct: {
        <Options extends SavePrePurchaseProductShopifyShopOptions>(inputs: (FullyQualifiedSavePrePurchaseProductShopifyShopVariables | SavePrePurchaseProductShopifyShopVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, SavePrePurchaseProductShopifyShopOptions>): Promise<SavePrePurchaseProductShopifyShopResult<Options>[]>;
        type: "action";
        ...
        optionsType: SavePrePurchaseProductShopifyShopOptions;
        schemaType: Query["shopifyShop"];
        variablesType: (FullyQualifiedSavePrePurchaseProductShopifyShopVariables | SavePrePurchaseProductShopifyShopVariables & {
            id: string;
        })[];
        variables: {
            inputs: {
