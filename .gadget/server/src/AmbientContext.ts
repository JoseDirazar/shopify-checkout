...
export interface AmbientContext {
  ...
  sessionID?: string;
  /** All checkout-testing configuration values */
  config: AppConfiguration;
  /** A map of connection name to instantiated connection objects for checkout-testing */
  connections: AppConnections;
  /** A high performance structured logger which writes logs to the Logs Viewer in the Gadget Editor. */
  logger: Logger;
  /**
   * An instance of the API client for checkout-testing.
   *
